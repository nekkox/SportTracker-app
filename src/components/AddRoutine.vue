...
const routine = ref({ exercise: "", routines: [] });
...
<template>
    <v-container>
        <v-card>
            ...
            <v-form>
                <v-container>
                    <SelectExercise v-model="exercise" />
                </v-container>
                    ...
                    <v-expansion-panel>
                        ...
                        <v-expansion-panel-text>
                            <v-row>
                                ...
                                <v-spacer />
                                <v-col cols="4" sm="2" class="justify-end align-center actionButtons">
                                    <v-btn type="submit" color="primary" @click.prevent="addRow" icon="mdi-plus" />
                                </v-col>
                            </v-row>
                    ...
                    <v-expansion-panel>
                        ...
                        <v-expansion-panel-text>
                            <v-row v-for="(entry, index) in routine.routines" :key="index">
                                ...
                                <v-spacer />
                                <v-col cols="4" sm="2" class="justify-end align-center actionButtons">
                                    <v-btn type="submit" size="x-small" @click.prevent="removeRow(index)"
            ...
            <v-card-actions>
                <v-btn type="submit" block size="large" color="primary" :disabled="routine.routines.length === 0"
                    @click.prevent="add">
                    Add
                </v-btn>
            </v-card-actions>
